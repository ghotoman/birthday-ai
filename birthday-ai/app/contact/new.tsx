...
export default function NewContactScreen() {
  ...
  const [attributes, setAttributes] = useState<{ category: AttributeCategory; value: string }[]>([]);
                ...
                <TouchableOpacity
                  ...
                  style={[
                    styles.chipSm,
                    {
                      ...
                      borderColor:
                        attrCategory === c ? colors.secondary : colors.border,
                    },
                  ]}
                >
                  <Text
